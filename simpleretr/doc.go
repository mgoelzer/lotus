...
//
//  {"type":"requestFoo", 
//   "request":"integer-type-of-request", 
//   "parameter1":"value1", ... }
//
// The integer request types are defined in this package (protocol.go) and correspond to
...
//
//  {"type":"response",
//  "response":"integer-response-type",
//  "responseCode":"integer-response-code", 
//  "data":"base64-encoded-bytes" }
//
// A response is integer response code and an optional data block.  In Go, they are
// marshalled/unmarshalled to/from structs, which are named as ResponseFoo, where Foo 
// is determined by the response integer type field.  
